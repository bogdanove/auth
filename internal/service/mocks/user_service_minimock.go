...
//go:generate minimock -i github.com/bogdanove/auth/internal/service.UserService -o user_service_minimock.go -n UserServiceMock -p mocks
...
type UserServiceMock struct {
	...
	funcCreateUser          func(ctx context.Context, req *model.UserInfo) (i1 int64, err error)
	funcCreateUserOrigin    string
	inspectFuncCreateUser   func(ctx context.Context, req *model.UserInfo)
	...
	funcGetUser          func(ctx context.Context, id int64) (up1 *user_v1.User, err error)
	...
	funcUpdateUser          func(ctx context.Context, req *model.UpdateUserInfo) (err error)
	funcUpdateUserOrigin    string
	inspectFuncUpdateUser   func(ctx context.Context, req *model.UpdateUserInfo)
...
func (mmCreateUser *mUserServiceMockCreateUser) Expect(ctx context.Context, req *model.UserInfo) *mUserServiceMockCreateUser {
	...
	mmCreateUser.defaultExpectation.params = &UserServiceMockCreateUserParams{ctx, req}
...
// ExpectReqParam2 sets up expected param req for UserService.CreateUser
func (mmCreateUser *mUserServiceMockCreateUser) ExpectReqParam2(req *model.UserInfo) *mUserServiceMockCreateUser {
	if mmCreateUser.mock.funcCreateUser != nil {
		mmCreateUser.mock.t.Fatalf("UserServiceMock.CreateUser mock is already set by Set")
	}
...
func (mmCreateUser *mUserServiceMockCreateUser) Inspect(f func(ctx context.Context, req *model.UserInfo)) *mUserServiceMockCreateUser {
...
func (mmCreateUser *mUserServiceMockCreateUser) Set(f func(ctx context.Context, req *model.UserInfo) (i1 int64, err error)) *UserServiceMock {
	if mmCreateUser.defaultExpectation != nil {
...
// Then helper
func (mmCreateUser *mUserServiceMockCreateUser) When(ctx context.Context, req *model.UserInfo) *UserServiceMockCreateUserExpectation {
	if mmCreateUser.mock.funcCreateUser != nil {
		mmCreateUser.mock.t.Fatalf("UserServiceMock.CreateUser mock is already set by Set")
	}
	...
	expectation := &UserServiceMockCreateUserExpectation{
		...
		params:             &UserServiceMockCreateUserParams{ctx, req},
...
func (mmCreateUser *UserServiceMock) CreateUser(ctx context.Context, req *model.UserInfo) (i1 int64, err error) {
	...
	mm_params := UserServiceMockCreateUserParams{ctx, req}
	...
	if mmCreateUser.CreateUserMock.defaultExpectation != nil {
		...
		mm_got := UserServiceMockCreateUserParams{ctx, req}
		...
		if mm_want_ptrs != nil {
			...
			if mm_want_ptrs.req != nil && !minimock.Equal(*mm_want_ptrs.req, mm_got.req) {
				mmCreateUser.t.Errorf("UserServiceMock.CreateUser got unexpected parameter req, expected at\n%s:\nwant: %#v\n got: %#v%s\n",
	...
	mmCreateUser.t.Fatalf("Unexpected call to UserServiceMock.CreateUser. %v %v", ctx, req)
	return
}
...
func (mmGetUser *mUserServiceMockGetUser) Return(up1 *user_v1.User, err error) *UserServiceMock {
	if mmGetUser.mock.funcGetUser != nil {
		mmGetUser.mock.t.Fatalf("UserServiceMock.GetUser mock is already set by Set")
	}
...
func (mmGetUser *mUserServiceMockGetUser) Set(f func(ctx context.Context, id int64) (up1 *user_v1.User, err error)) *UserServiceMock {
	if mmGetUser.defaultExpectation != nil {
...
func (e *UserServiceMockGetUserExpectation) Then(up1 *user_v1.User, err error) *UserServiceMock {
...
func (mmGetUser *UserServiceMock) GetUser(ctx context.Context, id int64) (up1 *user_v1.User, err error) {
...
func (mmUpdateUser *mUserServiceMockUpdateUser) Expect(ctx context.Context, req *model.UpdateUserInfo) *mUserServiceMockUpdateUser {
	...
	mmUpdateUser.defaultExpectation.params = &UserServiceMockUpdateUserParams{ctx, req}
...
// ExpectReqParam2 sets up expected param req for UserService.UpdateUser
func (mmUpdateUser *mUserServiceMockUpdateUser) ExpectReqParam2(req *model.UpdateUserInfo) *mUserServiceMockUpdateUser {
	if mmUpdateUser.mock.funcUpdateUser != nil {
		mmUpdateUser.mock.t.Fatalf("UserServiceMock.UpdateUser mock is already set by Set")
	}
...
func (mmUpdateUser *mUserServiceMockUpdateUser) Inspect(f func(ctx context.Context, req *model.UpdateUserInfo)) *mUserServiceMockUpdateUser {
...
func (mmUpdateUser *mUserServiceMockUpdateUser) Set(f func(ctx context.Context, req *model.UpdateUserInfo) (err error)) *UserServiceMock {
	if mmUpdateUser.defaultExpectation != nil {
...
// Then helper
func (mmUpdateUser *mUserServiceMockUpdateUser) When(ctx context.Context, req *model.UpdateUserInfo) *UserServiceMockUpdateUserExpectation {
	if mmUpdateUser.mock.funcUpdateUser != nil {
		mmUpdateUser.mock.t.Fatalf("UserServiceMock.UpdateUser mock is already set by Set")
	}
	...
	expectation := &UserServiceMockUpdateUserExpectation{
		...
		params:             &UserServiceMockUpdateUserParams{ctx, req},
...
func (mmUpdateUser *UserServiceMock) UpdateUser(ctx context.Context, req *model.UpdateUserInfo) (err error) {
	...
	mm_params := UserServiceMockUpdateUserParams{ctx, req}
	...
	if mmUpdateUser.UpdateUserMock.defaultExpectation != nil {
		...
		mm_got := UserServiceMockUpdateUserParams{ctx, req}
		...
		if mm_want_ptrs != nil {
			...
			if mm_want_ptrs.req != nil && !minimock.Equal(*mm_want_ptrs.req, mm_got.req) {
				mmUpdateUser.t.Errorf("UserServiceMock.UpdateUser got unexpected parameter req, expected at\n%s:\nwant: %#v\n got: %#v%s\n",
	...
	mmUpdateUser.t.Fatalf("Unexpected call to UserServiceMock.UpdateUser. %v %v", ctx, req)
	return
}

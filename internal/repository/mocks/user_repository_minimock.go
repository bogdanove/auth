...
//go:generate minimock -i github.com/bogdanove/auth/internal/repository.UserRepository -o user_repository_minimock.go -n UserRepositoryMock -p mocks
...
type UserRepositoryMock struct {
	...
	funcCreateUser          func(ctx context.Context, req *service.UserInfo) (i1 int64, err error)
	funcCreateUserOrigin    string
	inspectFuncCreateUser   func(ctx context.Context, req *service.UserInfo)
	...
	funcSaveLog          func(ctx context.Context, req *model.UserLog) (err error)
	funcSaveLogOrigin    string
	inspectFuncSaveLog   func(ctx context.Context, req *model.UserLog)
	afterSaveLogCounter  uint64
	beforeSaveLogCounter uint64
	SaveLogMock          mUserRepositoryMockSaveLog

	funcUpdateUser          func(ctx context.Context, req *service.UpdateUserInfo) (err error)
	funcUpdateUserOrigin    string
	inspectFuncUpdateUser   func(ctx context.Context, req *service.UpdateUserInfo)
...
func NewUserRepositoryMock(t minimock.Tester) *UserRepositoryMock {
	...
	m.SaveLogMock = mUserRepositoryMockSaveLog{mock: m}
	m.SaveLogMock.callArgs = []*UserRepositoryMockSaveLogParams{}
...
func (mmCreateUser *mUserRepositoryMockCreateUser) Expect(ctx context.Context, req *service.UserInfo) *mUserRepositoryMockCreateUser {
...
func (mmCreateUser *mUserRepositoryMockCreateUser) ExpectReqParam2(req *service.UserInfo) *mUserRepositoryMockCreateUser {
	if mmCreateUser.mock.funcCreateUser != nil {
		mmCreateUser.mock.t.Fatalf("UserRepositoryMock.CreateUser mock is already set by Set")
	}
...
func (mmCreateUser *mUserRepositoryMockCreateUser) Inspect(f func(ctx context.Context, req *service.UserInfo)) *mUserRepositoryMockCreateUser {
...
func (mmCreateUser *mUserRepositoryMockCreateUser) Set(f func(ctx context.Context, req *service.UserInfo) (i1 int64, err error)) *UserRepositoryMock {
	if mmCreateUser.defaultExpectation != nil {
...
// Then helper
func (mmCreateUser *mUserRepositoryMockCreateUser) When(ctx context.Context, req *service.UserInfo) *UserRepositoryMockCreateUserExpectation {
	if mmCreateUser.mock.funcCreateUser != nil {
		mmCreateUser.mock.t.Fatalf("UserRepositoryMock.CreateUser mock is already set by Set")
	}
...
func (mmCreateUser *UserRepositoryMock) CreateUser(ctx context.Context, req *service.UserInfo) (i1 int64, err error) {
...
type mUserRepositoryMockSaveLog struct {
	optional           bool
	mock               *UserRepositoryMock
	defaultExpectation *UserRepositoryMockSaveLogExpectation
	expectations       []*UserRepositoryMockSaveLogExpectation

	callArgs []*UserRepositoryMockSaveLogParams
	mutex    sync.RWMutex
...
// UserRepositoryMockSaveLogExpectation specifies expectation struct of the UserRepository.SaveLog
type UserRepositoryMockSaveLogExpectation struct {
	mock               *UserRepositoryMock
	params             *UserRepositoryMockSaveLogParams
	paramPtrs          *UserRepositoryMockSaveLogParamPtrs
	expectationOrigins UserRepositoryMockSaveLogExpectationOrigins
	results            *UserRepositoryMockSaveLogResults
	returnOrigin       string
	Counter            uint64
}

// UserRepositoryMockSaveLogParams contains parameters of the UserRepository.SaveLog
type UserRepositoryMockSaveLogParams struct {
	ctx context.Context
	req *model.UserLog
}

// UserRepositoryMockSaveLogParamPtrs contains pointers to parameters of the UserRepository.SaveLog
type UserRepositoryMockSaveLogParamPtrs struct {
	ctx *context.Context
	req **model.UserLog
}

// UserRepositoryMockSaveLogResults contains results of the UserRepository.SaveLog
type UserRepositoryMockSaveLogResults struct {
	err error
}

// UserRepositoryMockSaveLogOrigins contains origins of expectations of the UserRepository.SaveLog
type UserRepositoryMockSaveLogExpectationOrigins struct {
	origin    string
	originCtx string
	originReq string
}
...
// It is NOT RECOMMENDED to use this option unless you really need it, as default behaviour helps to
// catch the problems when the expected method call is totally skipped during test run.
func (mmSaveLog *mUserRepositoryMockSaveLog) Optional() *mUserRepositoryMockSaveLog {
	mmSaveLog.optional = true
	return mmSaveLog
}

// Expect sets up expected params for UserRepository.SaveLog
func (mmSaveLog *mUserRepositoryMockSaveLog) Expect(ctx context.Context, req *model.UserLog) *mUserRepositoryMockSaveLog {
	if mmSaveLog.mock.funcSaveLog != nil {
		mmSaveLog.mock.t.Fatalf("UserRepositoryMock.SaveLog mock is already set by Set")
	}

	if mmSaveLog.defaultExpectation == nil {
		mmSaveLog.defaultExpectation = &UserRepositoryMockSaveLogExpectation{}
	}

	if mmSaveLog.defaultExpectation.paramPtrs != nil {
		mmSaveLog.mock.t.Fatalf("UserRepositoryMock.SaveLog mock is already set by ExpectParams functions")
	}

	mmSaveLog.defaultExpectation.params = &UserRepositoryMockSaveLogParams{ctx, req}
	mmSaveLog.defaultExpectation.expectationOrigins.origin = minimock.CallerInfo(1)
	for _, e := range mmSaveLog.expectations {
		if minimock.Equal(e.params, mmSaveLog.defaultExpectation.params) {
			mmSaveLog.mock.t.Fatalf("Expectation set by When has same params: %#v", *mmSaveLog.defaultExpectation.params)
		}
	}
...
// ExpectCtxParam1 sets up expected param ctx for UserRepository.SaveLog
func (mmSaveLog *mUserRepositoryMockSaveLog) ExpectCtxParam1(ctx context.Context) *mUserRepositoryMockSaveLog {
	if mmSaveLog.mock.funcSaveLog != nil {
		mmSaveLog.mock.t.Fatalf("UserRepositoryMock.SaveLog mock is already set by Set")
	}
	...
	if mmSaveLog.defaultExpectation.params != nil {
		mmSaveLog.mock.t.Fatalf("UserRepositoryMock.SaveLog mock is already set by Expect")
	}

	if mmSaveLog.defaultExpectation.paramPtrs == nil {
		mmSaveLog.defaultExpectation.paramPtrs = &UserRepositoryMockSaveLogParamPtrs{}
	}
	mmSaveLog.defaultExpectation.paramPtrs.ctx = &ctx
	mmSaveLog.defaultExpectation.expectationOrigins.originCtx = minimock.CallerInfo(1)

	return mmSaveLog
}

// ExpectReqParam2 sets up expected param req for UserRepository.SaveLog
func (mmSaveLog *mUserRepositoryMockSaveLog) ExpectReqParam2(req *model.UserLog) *mUserRepositoryMockSaveLog {
	if mmSaveLog.mock.funcSaveLog != nil {
		mmSaveLog.mock.t.Fatalf("UserRepositoryMock.SaveLog mock is already set by Set")
	}
	...
	mmSaveLog.defaultExpectation.paramPtrs.req = &req
	mmSaveLog.defaultExpectation.expectationOrigins.originReq = minimock.CallerInfo(1)

	return mmSaveLog
}

// Inspect accepts an inspector function that has same arguments as the UserRepository.SaveLog
func (mmSaveLog *mUserRepositoryMockSaveLog) Inspect(f func(ctx context.Context, req *model.UserLog)) *mUserRepositoryMockSaveLog {
	if mmSaveLog.mock.inspectFuncSaveLog != nil {
		mmSaveLog.mock.t.Fatalf("Inspect function is already set for UserRepositoryMock.SaveLog")
	}

	mmSaveLog.mock.inspectFuncSaveLog = f

	return mmSaveLog
}

// Return sets up results that will be returned by UserRepository.SaveLog
func (mmSaveLog *mUserRepositoryMockSaveLog) Return(err error) *UserRepositoryMock {
	if mmSaveLog.mock.funcSaveLog != nil {
		mmSaveLog.mock.t.Fatalf("UserRepositoryMock.SaveLog mock is already set by Set")
	}

	if mmSaveLog.defaultExpectation == nil {
		mmSaveLog.defaultExpectation = &UserRepositoryMockSaveLogExpectation{mock: mmSaveLog.mock}
	}
	mmSaveLog.defaultExpectation.results = &UserRepositoryMockSaveLogResults{err}
	mmSaveLog.defaultExpectation.returnOrigin = minimock.CallerInfo(1)
	return mmSaveLog.mock
}

// Set uses given function f to mock the UserRepository.SaveLog method
func (mmSaveLog *mUserRepositoryMockSaveLog) Set(f func(ctx context.Context, req *model.UserLog) (err error)) *UserRepositoryMock {
	if mmSaveLog.defaultExpectation != nil {
		mmSaveLog.mock.t.Fatalf("Default expectation is already set for the UserRepository.SaveLog method")
	}

	if len(mmSaveLog.expectations) > 0 {
		mmSaveLog.mock.t.Fatalf("Some expectations are already set for the UserRepository.SaveLog method")
	}

	mmSaveLog.mock.funcSaveLog = f
	mmSaveLog.mock.funcSaveLogOrigin = minimock.CallerInfo(1)
	return mmSaveLog.mock
}

// When sets expectation for the UserRepository.SaveLog which will trigger the result defined by the following
// Then helper
func (mmSaveLog *mUserRepositoryMockSaveLog) When(ctx context.Context, req *model.UserLog) *UserRepositoryMockSaveLogExpectation {
	if mmSaveLog.mock.funcSaveLog != nil {
		mmSaveLog.mock.t.Fatalf("UserRepositoryMock.SaveLog mock is already set by Set")
	}

	expectation := &UserRepositoryMockSaveLogExpectation{
		mock:               mmSaveLog.mock,
		params:             &UserRepositoryMockSaveLogParams{ctx, req},
		expectationOrigins: UserRepositoryMockSaveLogExpectationOrigins{origin: minimock.CallerInfo(1)},
	}
	mmSaveLog.expectations = append(mmSaveLog.expectations, expectation)
	return expectation
}

// Then sets up UserRepository.SaveLog return parameters for the expectation previously defined by the When method
func (e *UserRepositoryMockSaveLogExpectation) Then(err error) *UserRepositoryMock {
	e.results = &UserRepositoryMockSaveLogResults{err}
	return e.mock
}

// Times sets number of times UserRepository.SaveLog should be invoked
func (mmSaveLog *mUserRepositoryMockSaveLog) Times(n uint64) *mUserRepositoryMockSaveLog {
	if n == 0 {
		mmSaveLog.mock.t.Fatalf("Times of UserRepositoryMock.SaveLog mock can not be zero")
	}
	mm_atomic.StoreUint64(&mmSaveLog.expectedInvocations, n)
	mmSaveLog.expectedInvocationsOrigin = minimock.CallerInfo(1)
	return mmSaveLog
}

func (mmSaveLog *mUserRepositoryMockSaveLog) invocationsDone() bool {
	if len(mmSaveLog.expectations) == 0 && mmSaveLog.defaultExpectation == nil && mmSaveLog.mock.funcSaveLog == nil {
		return true
	}

	totalInvocations := mm_atomic.LoadUint64(&mmSaveLog.mock.afterSaveLogCounter)
	expectedInvocations := mm_atomic.LoadUint64(&mmSaveLog.expectedInvocations)

	return totalInvocations > 0 && (expectedInvocations == 0 || expectedInvocations == totalInvocations)
}

// SaveLog implements mm_repository.UserRepository
func (mmSaveLog *UserRepositoryMock) SaveLog(ctx context.Context, req *model.UserLog) (err error) {
	mm_atomic.AddUint64(&mmSaveLog.beforeSaveLogCounter, 1)
	defer mm_atomic.AddUint64(&mmSaveLog.afterSaveLogCounter, 1)

	mmSaveLog.t.Helper()

	if mmSaveLog.inspectFuncSaveLog != nil {
		mmSaveLog.inspectFuncSaveLog(ctx, req)
	}

	mm_params := UserRepositoryMockSaveLogParams{ctx, req}

	// Record call args
	mmSaveLog.SaveLogMock.mutex.Lock()
	mmSaveLog.SaveLogMock.callArgs = append(mmSaveLog.SaveLogMock.callArgs, &mm_params)
	mmSaveLog.SaveLogMock.mutex.Unlock()

	for _, e := range mmSaveLog.SaveLogMock.expectations {
		if minimock.Equal(*e.params, mm_params) {
			mm_atomic.AddUint64(&e.Counter, 1)
			return e.results.err
		}
	...
	if mmSaveLog.SaveLogMock.defaultExpectation != nil {
		mm_atomic.AddUint64(&mmSaveLog.SaveLogMock.defaultExpectation.Counter, 1)
		mm_want := mmSaveLog.SaveLogMock.defaultExpectation.params
		mm_want_ptrs := mmSaveLog.SaveLogMock.defaultExpectation.paramPtrs

		mm_got := UserRepositoryMockSaveLogParams{ctx, req}

		if mm_want_ptrs != nil {

			if mm_want_ptrs.ctx != nil && !minimock.Equal(*mm_want_ptrs.ctx, mm_got.ctx) {
				mmSaveLog.t.Errorf("UserRepositoryMock.SaveLog got unexpected parameter ctx, expected at\n%s:\nwant: %#v\n got: %#v%s\n",
					mmSaveLog.SaveLogMock.defaultExpectation.expectationOrigins.originCtx, *mm_want_ptrs.ctx, mm_got.ctx, minimock.Diff(*mm_want_ptrs.ctx, mm_got.ctx))
			}

			if mm_want_ptrs.req != nil && !minimock.Equal(*mm_want_ptrs.req, mm_got.req) {
				mmSaveLog.t.Errorf("UserRepositoryMock.SaveLog got unexpected parameter req, expected at\n%s:\nwant: %#v\n got: %#v%s\n",
					mmSaveLog.SaveLogMock.defaultExpectation.expectationOrigins.originReq, *mm_want_ptrs.req, mm_got.req, minimock.Diff(*mm_want_ptrs.req, mm_got.req))
			}

		} else if mm_want != nil && !minimock.Equal(*mm_want, mm_got) {
			mmSaveLog.t.Errorf("UserRepositoryMock.SaveLog got unexpected parameters, expected at\n%s:\nwant: %#v\n got: %#v%s\n",
				mmSaveLog.SaveLogMock.defaultExpectation.expectationOrigins.origin, *mm_want, mm_got, minimock.Diff(*mm_want, mm_got))
		}

		mm_results := mmSaveLog.SaveLogMock.defaultExpectation.results
		if mm_results == nil {
			mmSaveLog.t.Fatal("No results are set for the UserRepositoryMock.SaveLog")
		}
		return (*mm_results).err
	}
	if mmSaveLog.funcSaveLog != nil {
		return mmSaveLog.funcSaveLog(ctx, req)
	}
	mmSaveLog.t.Fatalf("Unexpected call to UserRepositoryMock.SaveLog. %v %v", ctx, req)
	return
}

// SaveLogAfterCounter returns a count of finished UserRepositoryMock.SaveLog invocations
func (mmSaveLog *UserRepositoryMock) SaveLogAfterCounter() uint64 {
	return mm_atomic.LoadUint64(&mmSaveLog.afterSaveLogCounter)
}

// SaveLogBeforeCounter returns a count of UserRepositoryMock.SaveLog invocations
func (mmSaveLog *UserRepositoryMock) SaveLogBeforeCounter() uint64 {
	return mm_atomic.LoadUint64(&mmSaveLog.beforeSaveLogCounter)
}

// Calls returns a list of arguments used in each call to UserRepositoryMock.SaveLog.
// The list is in the same order as the calls were made (i.e. recent calls have a higher index)
func (mmSaveLog *mUserRepositoryMockSaveLog) Calls() []*UserRepositoryMockSaveLogParams {
	mmSaveLog.mutex.RLock()

	argCopy := make([]*UserRepositoryMockSaveLogParams, len(mmSaveLog.callArgs))
	copy(argCopy, mmSaveLog.callArgs)

	mmSaveLog.mutex.RUnlock()

	return argCopy
}

// MinimockSaveLogDone returns true if the count of the SaveLog invocations corresponds
// the number of defined expectations
func (m *UserRepositoryMock) MinimockSaveLogDone() bool {
	if m.SaveLogMock.optional {
		// Optional methods provide '0 or more' call count restriction.
		return true
	}

	for _, e := range m.SaveLogMock.expectations {
		if mm_atomic.LoadUint64(&e.Counter) < 1 {
			return false
		}
	}

	return m.SaveLogMock.invocationsDone()
}

// MinimockSaveLogInspect logs each unmet expectation
func (m *UserRepositoryMock) MinimockSaveLogInspect() {
	for _, e := range m.SaveLogMock.expectations {
		if mm_atomic.LoadUint64(&e.Counter) < 1 {
			m.t.Errorf("Expected call to UserRepositoryMock.SaveLog at\n%s with params: %#v", e.expectationOrigins.origin, *e.params)
		}
	}

	afterSaveLogCounter := mm_atomic.LoadUint64(&m.afterSaveLogCounter)
	// if default expectation was set then invocations count should be greater than zero
	if m.SaveLogMock.defaultExpectation != nil && afterSaveLogCounter < 1 {
		if m.SaveLogMock.defaultExpectation.params == nil {
			m.t.Errorf("Expected call to UserRepositoryMock.SaveLog at\n%s", m.SaveLogMock.defaultExpectation.returnOrigin)
		} else {
			m.t.Errorf("Expected call to UserRepositoryMock.SaveLog at\n%s with params: %#v", m.SaveLogMock.defaultExpectation.expectationOrigins.origin, *m.SaveLogMock.defaultExpectation.params)
		}
	}
	// if func was set then invocations count should be greater than zero
	if m.funcSaveLog != nil && afterSaveLogCounter < 1 {
		m.t.Errorf("Expected call to UserRepositoryMock.SaveLog at\n%s", m.funcSaveLogOrigin)
	}

	if !m.SaveLogMock.invocationsDone() && afterSaveLogCounter > 0 {
		m.t.Errorf("Expected %d calls to UserRepositoryMock.SaveLog at\n%s but found %d calls",
			mm_atomic.LoadUint64(&m.SaveLogMock.expectedInvocations), m.SaveLogMock.expectedInvocationsOrigin, afterSaveLogCounter)
	}
}
...
func (mmUpdateUser *mUserRepositoryMockUpdateUser) Expect(ctx context.Context, req *service.UpdateUserInfo) *mUserRepositoryMockUpdateUser {
	...
	mmUpdateUser.defaultExpectation.params = &UserRepositoryMockUpdateUserParams{ctx, req}
...
// ExpectReqParam2 sets up expected param req for UserRepository.UpdateUser
func (mmUpdateUser *mUserRepositoryMockUpdateUser) ExpectReqParam2(req *service.UpdateUserInfo) *mUserRepositoryMockUpdateUser {
	if mmUpdateUser.mock.funcUpdateUser != nil {
		mmUpdateUser.mock.t.Fatalf("UserRepositoryMock.UpdateUser mock is already set by Set")
	}
...
func (mmUpdateUser *mUserRepositoryMockUpdateUser) Inspect(f func(ctx context.Context, req *service.UpdateUserInfo)) *mUserRepositoryMockUpdateUser {
...
func (mmUpdateUser *mUserRepositoryMockUpdateUser) Set(f func(ctx context.Context, req *service.UpdateUserInfo) (err error)) *UserRepositoryMock {
	if mmUpdateUser.defaultExpectation != nil {
...
// Then helper
func (mmUpdateUser *mUserRepositoryMockUpdateUser) When(ctx context.Context, req *service.UpdateUserInfo) *UserRepositoryMockUpdateUserExpectation {
	if mmUpdateUser.mock.funcUpdateUser != nil {
		mmUpdateUser.mock.t.Fatalf("UserRepositoryMock.UpdateUser mock is already set by Set")
	}
	...
	expectation := &UserRepositoryMockUpdateUserExpectation{
		...
		params:             &UserRepositoryMockUpdateUserParams{ctx, req},
...
func (mmUpdateUser *UserRepositoryMock) UpdateUser(ctx context.Context, req *service.UpdateUserInfo) (err error) {
	...
	mm_params := UserRepositoryMockUpdateUserParams{ctx, req}
	...
	if mmUpdateUser.UpdateUserMock.defaultExpectation != nil {
		...
		mm_got := UserRepositoryMockUpdateUserParams{ctx, req}
		...
		if mm_want_ptrs != nil {
			...
			if mm_want_ptrs.req != nil && !minimock.Equal(*mm_want_ptrs.req, mm_got.req) {
				mmUpdateUser.t.Errorf("UserRepositoryMock.UpdateUser got unexpected parameter req, expected at\n%s:\nwant: %#v\n got: %#v%s\n",
	...
	mmUpdateUser.t.Fatalf("Unexpected call to UserRepositoryMock.UpdateUser. %v %v", ctx, req)
	return
}
